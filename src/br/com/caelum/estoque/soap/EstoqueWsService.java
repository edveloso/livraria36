 ...
 * 
 */
@WebServiceClient(name = "EstoqueWsService", targetNamespace = "http://caelum.com.br/v1/estoquews", wsdlLocation = "http://localhost:8080/EstoqueService/EstoqueWs?WSDL")
    ...
    extends Service
{
    ...
    private final static QName ESTOQUEWSSERVICE_QNAME = new QName("http://caelum.com.br/v1/estoquews", "EstoqueWsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/EstoqueService/EstoqueWs?WSDL");
    ...
    public EstoqueWs getEstoqueWsPort() {
        return super.getPort(new QName("http://caelum.com.br/v1/estoquews", "EstoqueWsPort"), EstoqueWs.class);
    }
    ...
    public EstoqueWs getEstoqueWsPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://caelum.com.br/v1/estoquews", "EstoqueWsPort"), EstoqueWs.class, features);
    }
