...
public class OAuthCodeController {
	...
	private static final String AUTH_CODE_FORM_URL = "http://localhost:8080/payfast/oauth/code/form";
	
	private static final String AUTH_CODE_TOKEN_URL = "http://localhost:8080/payfast/oauth/code/token";
	...
	public String oauthReturn(HttpServletRequest request) throws Exception{
		...
		OAuthClientRequest oauthRequest = OAuthClientRequest
											.tokenLocation(AUTH_CODE_FORM_URL)
		...
		OAuthJSONAccessTokenResponse tokenResponse = client.accessToken(oauthRequest
	...
	public void setAccessToken(AcessToken accessToken) {
